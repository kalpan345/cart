...
VALUES ('Mobile', 'OnePlus 7T', 1, 35.75);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Pen', 'Parker pen', 5, 34.50);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Laptop', 'Macbook Air', 3, 1500.00);
INSERT INTO PRODUCT (name, description, quantity, price)
...
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Accessories', 'Equipement for computers (mouse,keyboard,etc.)', 500, 300.00);
INSERT INTO PRODUCT (name, description, quantity, price)
